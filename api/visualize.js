/**
 * Lightweight embedding visualization for Vercel serverless functions
 * Uses a simple approach without heavy ML libraries
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Generate a simple visualization using SVG (lightweight alternative)
...
function performSimpleClustering(lean_codes) {
  // Simple clustering based on code characteristics
